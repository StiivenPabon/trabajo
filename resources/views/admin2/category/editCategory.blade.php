...
<div class="conten-form">
  <form method="POST" action="{{ route('categorys.update', $categoria->id) }}">
      ...
      <div class="form-group">
          ...
          <textarea class="form-control" id="exampleText" name="description" rows="4">{{ $categoria->description }}</textarea>
      </div>
      <div class="form-group d-flex justify-content-between">
          <button type="submit" class="btn btn-primary mr-1">Actualizar Categoria</button>
          <button type="button" class="btn btn-danger" onclick="cancelarActualizacion()">Cancelar actualización</button>
      </div>
  </form>
</div>
